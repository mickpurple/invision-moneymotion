...
class _cleanup extends \IPS\Task
{
	...
	public function execute()
	{
		...
		if( \IPS\Settings::i()->report_guest_details_store_days )
		{
			\IPS\Db::i()->update( 'core_rc_reports', [ 'guest_name' => null, 'guest_email' => null ], array( 'date_reported < ?', \IPS\DateTime::create()->sub( new \DateInterval( 'P' . \IPS\Settings::i()->report_guest_details_store_days . 'D' ) )->getTimestamp() ) );
		}
