...
$lang = array(
	...
	'security'				=> "Security",
	'renew_title'			=> "Renew: %s",
	'renew_payment_no_ba'	=> "Orphaned Billing Agreement Payment: %s",
	'renew_option'			=> "%s/%s",
	'order' 				=> "Order",
	'cm' 					=> "cm",
	'inches' 				=> "inches",
	...
	'renew_days_no_term'	=> "{!#[1:day][?:days]}",
	'renew_weeks_no_term'	=> "{!#[1:week][?:weeks]}",
	'renew_months_no_term'	=> "{!#[1:month][?:months]}",
	'renew_years_no_term'	=> "{!#[1:year][?:years]}",
	...
	'__defart_support_request_plural'	=> "support {!#[1:request][?:requests]}",
	'__defart_product_reviews'	=> "product review",
	'__defart_product_reviews_plural'	=> "product {!#[1:review][?:reviews]}",
	'__defart_product'			=> "product",
	'__defart_product_plural'	=> "{!#[1:product][?:products]}",
	'plus_tax_rate'				=> " + %s",
	...
	'product_groups_sg' => "Product Group",
	...
	'filestorage__nexus_Gateways'			=> "Payment Gateways",
	...
	'contact_nexus_title_with_name' => "Support Request from %s created via Contact Us Form",
	...
	'stripe_webhook_blurb'		=> "You must <a href='{external.stripe_webhooks}' target='_blank' rel='noopener'>create a webhook</a> on your Stripe account specifying this URL as the endpoint:<br><pre class='ipsCode'>%s</pre> <p>Required Events: </p><pre class='ipsCode'>%s</pre>",
	...
	'stripe_address_postal_code_check_unchecked'=> "Zip check not performed",
	'stripe_address_postal_code_check_unavailable'=> "Zip check unavailable",
	'stripe_address_postal_code_check_pass'		=> "Zip check passed",
	'stripe_address_postal_code_check_fail'		=> "Zip check failed",
	...
	'stripe_apple_verificationfile' => "Apple Pay Verification File",
	...
	'gateway__Braintree_desc'	=> "Requires comprehensive application process. <a href='{external.braintree_doc}' rel='noopener' target='_blank' >More information</a>",
	...
	'acplogs__nexus_added_gateway'											=> "Added %s payment method.",
	'nexus_gateways_deprecated'												=> "The Braintree, Authorize.Net and 2Checkout gateways have been deprecated and will be removed in a future version. Please make alternative plans if you are using this functionality.",
	...
	'maxmind_torExit_n'							=> "Not a known Tor exit node",
	'maxmind_torExit_y'							=> "Tor exit node",
	'maxmind_torExit_desc'						=> "Tor often used to circumvent IP geolocation restrictions.",
	...
	'maxmind_footer_insights'					=> "Data provided by MaxMind minFraud Insights (%s)",
	...
	'maxmind_id'								=> "Maxmind Account ID",
	'transaction_last_four' 					=> "Card ending in %s",
	'history_payment_rejected' 					=> "Payment rejected: %s",
	'maxmind_disposable_n'						=> "Not a disposable email provider",
	'maxmind_free_n'							=> "Not a free email address",
	'maxmind_high_risk_n'						=> "Not a known high-risk email address",
	'maxmind_disposable_y'						=> "Known disposable email provider",
	'maxmind_free_y'							=> "Known free email address",
	'maxmind_high_risk_y'						=> "Known high-risk email address",
	'maxmind_tracking_code'						=> "Tracking Code",
	'maxmind_tracking_code_desc'				=> "Using the Device Tracking Add-On for minFraud on you community improves the ability to detect fraud. The device tracking add-on uses cookies and local storage as one method of distinguishing unique devices. <a href='{external.maxmind_tracking}' target='_blank' rel='noopener'>Learn more</a>.",
	...
	'currency_code_lang_missing'	=> "%s does not have a default currency.",
	'currency_code_multiple_default' => "%s has multiple default currencies defined.",
	...
	'nexus_require_billing'			=> "Require customer's real name and Billing Address for",
	...
	'cm_invoice_generate_desc'		=> "If a customer has account credit or a card on file this is when payment will be taken, otherwise it is when the customer will be sent an email instructing them to pay.<br>Usually it is best to set this relatively close to the expiration date so that the customer isn't charged before they expect. However, if you are selling products where a service interruption would be problematic, you should either set this long enough that the customer will always have time to submit payment before the expiration, or make use of the Grace Period setting on each product to allow some additional time to pay.<br><strong>If a PayPal Subscription is active</strong>: Invoices will be generated at the time of automated payment regardless of this setting value.",
	...
	/* !Invoice Tracking */
	'mailsub__nexus_invoiceNotify'	=> "A tracked invoice has been marked paid",
	'mailsub__nexus_invoiceTrackExpired'	=> "A tracked invoice has expired",
	'invoice_track'	=> 'Track',
	'invoice_untrack'	=> 'Untrack',
	...
	'you_agree_to_tac'		=> "By clicking the confirm button, you agree to the <a href='%s' target='_blank' rel='noopener'><strong>terms and conditions</strong></a>.",
	...
	'manage_orders_in_billing' => "You can manage your orders in <a href='{internal.front.app=nexus&module=clients&controller=invoices.clientsinvoices}'>Your Orders</a>",
	'track_orders_in_billing' => "You can keep track of the status of this order in <a href='{internal.front.app=nexus&module=clients&controller=invoices.clientsinvoices}'>Your Orders</a>",
	...
	'f_subscriptions'				=> "Subscription being purchased includes",
	'f_blurb_subscriptions'			=> "Purchasing subscription %s",
	...
	'account_credit_remove_commission'	=> "%s account credit will be taken from %s (referral commission).",
	...
	'package_cannot_reactivate_error' => "This purchase cannot be re-activated.",
	...
	'can_not_reactivate'			=> "This purchase cannot be reactivated.",
	...
	'nexus_payout_confirm_title'    => "Process Withdrawals",
	'nexus_payout_proceed'          => "Proceed",
	'nexus_payout_confirm_text'     => "Are you sure? This action cannot be undone.",
	...
	'nexus_payout_unlimited_times'  => "Unlimited number of Withdrawals?",
	'nexus_payout_unlimited_times_desc'    => "When disabled, the end user will need to cancel any active withdrawal request (per currency) before creating another.",
	'po_status'						=> "Status",
	'po_id'							=> "ID",
	...
	'task__payoutPending'			=> "Synchronizes the status of Mass Payouts",
	...
	/* !Support */
	'nexus_support_deprecated'	=> "Support requests have been deprecated and will be removed in a future version. <a href='{external.deprecations_support}' target='_blank' rel='noopener'>What does this mean?</a> <a href='%s' class='ipsPos_right ipsButton ipsButton_primary ipsButton_veryVerySmall'>Dismiss</a>",
	...
	'next_request_not_found'            => "There are no more support requests matching your criteria.",
	...
	/* !Products */
	'nexus_physical_deprecated'			=> "Physical product sales have been deprecated and will be removed in a future version. <a href='{external.deprecations_physical_products}' target='_blank' rel='noopener'>What does this mean?</a> <a href='%s' class='ipsPos_right ipsButton ipsButton_primary ipsButton_veryVerySmall'>Dismiss</a>",
	...
	'acplogs__nexus_package_hidden'		=> "%s hidden from the store.",
	...
	'gift_voucher_invalid_value'		=> "You must enter a valid amount",
	...
	'not_enough_in_stock_checkout'		=> "There is not enough stock to fulfill your order. There {!#[1:is][?:are] #} of %s remaining in stock.",
	...
	'err_sub_subscription_bought' 		=> "You are only allowed to purchase one subscription, and you have already done so. <br><a href='{internal.app=nexus&module=subscriptions&controller=subscriptions}' class='ipsButton ipsButton_primary ipsSpacer_top'>Manage existing Subscription</a>",
	...
	'acplogs__nexus_store_settings'				=> "Store settings updated",
	...
	'altcontact_email_desc'				=> "If the user does not already have an account, they first need to <a href='{internal.front.app=core&module=system&controller=register.register}'>create one</a>.",
	...
	'altcontact_none'					=> "You don't have any alternative contacts set up. Would you like to <a href='{internal.front.app=nexus&module=clients&controller=alternatives&do=form.clientsalternatives}' data-ipsDialog data-ipsDialog-size='medium' data-ipsDialog-title='%s'>set one up now</a>?",
	...
	'credit_withdraw_processing'		=> "This withdrawal is being processed",
	...
	'nexus_no_donations_found' 			=> "There are no donations currently",
	...
	'email_transaction_wait'			=> "The following transaction is currently pending payment.",
...
At this stage, no further action is required from you. We will send you an additional email once your payment has been approved.",
	...
	'email_tracked_invoice_paid'		=> "An invoice you are tracking has been marked paid",
	'email_tracked_invoice_expired'		=> "An invoice you are tracking has expired",
	'emailtpl_invoiceNotify'			=> "Tracked invoice marked paid",
	'emailtpl_invoiceTrackExpired'		=> "Tracked invoice expired",
	...
	'view_this_product'					=> 'View the product',
	...
	'not_with_existing_subscription'	=> "This purchase cannot be reactivated because this customer already has an existing subscription.",
	'acplogs__nexus_sub_converted'		=> "%s converted to subscription package.",
	'acplogs__nexus_sub_hidden'			=> "%s hidden from store.",
	...
	'nexus_subs_register' => "Require Subscription Purchase?",
	'nexus_subs_register_none' => "Never.",
	'nexus_subs_register_reg' => "When registering a new account.",
	'nexus_subs_register_reg_desc' => "Member accounts created via other methods (Zapier, REST API, Social Media, CSV Import) will be asked to purchase a Subscription if their account is less than 30 days old.",
	'nexus_subs_register_always' => "Always.",
	'nexus_subs_register_always_desc' => "A subscription must be purchased when registering a new account and kept active to retain access to the community.",
	'nexus_subs_register_desc' => "This does not apply to Administrators or Moderators, they will be able to access the community.",
	...
	'nexus_sub_no_change_ba' => "Subscriptions cannot be changed when an active PayPal subscription is in place, please <a href='{internal.app=nexus&module=clients&controller=billingagreements.clientsbillingagreements}'>cancel</a> it first.",
	...
	'nexus_subs_add_member_already_subscribed' => "This member already has a Subscription",
	'nexus_subs_free_period' => "Renewals",
	'nexus_subs_forever'    => "Free forever",
	'nexus_subs_until_renew' => "Free for %s %s and then %s per %s",
	...
	'nexus_queue_missing_sub_purchases' => "Fixing Subscriptions",
	...
	'nexus_subs_subscribed_cancelled' => "Your subscription has been cancelled.",
	'nexus_subs_subscribed_cancelled_no_reactivate' => "Your subscription has been cancelled, please contact us to reactivate.",
	'nexus_subs_cancel'				=> "Cancel Subscription",
	'nexus_subs_view_purchase'				=> "View Purchase",
	'nexus_subs_upgrade_button'				=> "Upgrade",
	'nexus_subs_downgrade_button'				=> "Downgrade",
	'nexus_subs_switch_button'				=> "Switch",
	...
	'nexus_sub_change_confirm_switch' => "The switch from %s to %s will cost %s.",
	...
	'nexus_sub_needed_title'  => "Select Subscription",
	'nexus_sub_needed_desc' => "An active subscription is required to access our community, please purchase one to continue.",
	...
	'nexus_subs_non_available' => "There are no subscriptions available at this time.",
	'nexus_subs_paid_flash_msg' => "Thanks for your payment, you're all set!",
	'nexus_sub_active_billingagreement_desc' => "Since you have an active PayPal Subscription to pay the subscription renewal fee, this must be <a href='%s' class='ipsButton_link--negative'>cancelled</a> before changing your Subscription package. ",
	...
	'mailsub__nexus_acp_notification_Transaction' => 'Transaction #{$transaction->id} requires manual action',
	...
	'mailsub__nexus_acp_notification_Withdrawal' => 'Withdrawal #{$withdrawal->id|raw} requires approval',
	...
	'mailsub__nexus_acp_notification_Shipment' => 'Shipment #{$shipment->id} ready to send',
	...
	'acp_notification_nexus_config_error_payoutmethod'	=> "Withdrawal settings need updating",
	'acp_notification_nexus_config_error_payoutmethod_desc' => "%s withdrawal settings need to be reviewed. Payout issues may occur until this is addressed.",
	...
	'acp_notification_Maxmind'                  => "Maxmind configuration issues",
	'acp_notification_nexus_maxmind'			=> "Maxmind configuration error",
	'acp_notification_nexus_maxmind_body'		=> "A new version of the Maxmind API is in use. Please add your Maxmind account ID to the settings.",
	'acp_notification_nexus_maxmind_sub'		=> "Account ID required",
	...
	'emailstats__invoiceNotify'					=> "New Invoice created",
	'emailstats__invoiceTrackExpired'			=> "Tracked Invoice expired",
	...
	/* Achievements */
	'achievement_filter_Subscriptions_node_prefix' => "Subscriptions",
	'achievement_filter_Subscriptions_nth' => "Add a milestone condition",
	'achievement_filter_Subscriptions' => "Add a subscription filter",
	'achievement_filter_Subscription_nth_suffix' => "<span data-role='th'>th</span> subscription",
	'AchievementAction__Subscription' => "Member purchases a subscription",
	'AchievementAction__Subscription_title' => "User purchased",
	'AchievementAction__Subscription_title_generic' => "Subscription",
	'achievement_filter_Subscriptions_active' => "active subscriptions",
	'achievements_filter_Subscription_type' => "of type %s",
	'achievements_filter_Subscription_pl' => "%s subscriptions",

	'AchievementAction__Package' => "Member purchases a product",
	'achievement_filter_Package' => "Add a product filter",
	'achievement_filter_Package_node_prefix' => "The product is in the group",
	'achievement_filter_Package_nth' => "Add a milestone condition",
	'achievement_filter_Package_nth_suffix' => "<span data-role='th'>th</span> purchase",
	'AchievementAction__Package_title_generic' => "product purchased",
	'AchievementAction__Package_title' => "Purchase",
	'purchase_groups_lc' => "product groups",
	'AchievementAction__Package_log' => "Purchased the product %s",
	'removing_subscriptions'		=> "Removing Subscriptions",

	/* Credit Card Processor Response Codes */
	'processor_response_code' => "Processor Response Code",
    'processor_response_code__1' => "Credit Card company has declined the transaction",
    'processor_response_code__3' => "Invalid Merchant",
    'processor_response_code__4' => "Do Not Honor - capture card",
    'processor_response_code__5' => "Do Not Honor - call bank",
    'processor_response_code__6' => "Customer block on recurring payment",
    'processor_response_code__7' => "Customer block on all recurring payments",
    'processor_response_code__9' => "Unpaid items on customer account prevent transaction",
    'processor_response_code__10' => "Partial Approval",
    'processor_response_code__12' => "Invalid Transaction",
    'processor_response_code__13' => "Card Amount Invalid",
    'processor_response_code__14' => "Card Number Invalid",
    'processor_response_code__15' => "No Such Issuer",
    'processor_response_code__19' => "Re-Enter",
    'processor_response_code__24' => "Incorrect Expiration Date",
    'processor_response_code__51' => "Insufficient Funds",
    'processor_response_code__54' => "Card Expired",
    'processor_response_code__55' => "Wrong PIN Entered by Card Holder",
    'processor_response_code__57' => "Transaction not permitted to issuer/cardholder",
    'processor_response_code__61' => "Customer Exceeds Withdrawal Limit",
    'processor_response_code__62' => "Restricted SIC Code",
    'processor_response_code__63' => "Security violation",
    'processor_response_code__65' => "Customer Exceeds Activity Limit",
    'processor_response_code__78' => "No Account",
    'processor_response_code__80' => "Invalid Date",
    'processor_response_code__82' => "CVV data is not correct",
    'processor_response_code__83' => "Cannot verify the PIN",
    'processor_response_code__93' => "Transaction could not be completed",
    'processor_response_code__97' => "CVV Mismatch",
    'processor_response_code__100' => "Generic Decline",
    'processor_response_code__AA' => "AVS No Match: Address",
    'processor_response_code__AI' => "AVS International AVS Not Supported",
    'processor_response_code__AN' => "AVS Not Supported",
    'processor_response_code__AU' => "AVS Unavailable",
    'processor_response_code__AW' => "AVS Not Working",
    'processor_response_code__AX' => "AVS: No Match: Address and ZIP",
    'processor_response_code__AY' => "AVS: No Match: Address or ZIP",
    'processor_response_code__AZ' => "AVS: No Match: ZIP",
    'processor_response_code__BC' => "Card Brand Not Supported",
    'processor_response_code__BD' => "Merchant Deactivated",
    'processor_response_code__BT' => "Terminal File Configuration Error",
    'processor_response_code__BM' => "Merchant File Configuration Error",
    'processor_response_code__CE' => "No Match: CVV",
    'processor_response_code__CN' => "CVV Not Supported",
    'processor_response_code__CR' => "Chip Card Removed",
    'processor_response_code__CV' => "No Match: CVV",
    'processor_response_code__DT' => "Duplicate Transaction",
    'processor_response_code__FB' => "Fraud Card Blocked",
    'processor_response_code__FF' => "Fraud Engine",
    'processor_response_code__FG' => "Account blocked for fraud",
    'processor_response_code__GF' => "General Format Error",
    'processor_response_code__GL' => "General Login Error",
    'processor_response_code__GS' => "General System Error",
    'processor_response_code__GK' => "General System Unknown Error",
    'processor_response_code__GU' => "General Upstream Error. There was a problem connecting to the processing networks.",
    'processor_response_code__LD' => "Merchant Daily Limit Exceeded",
    'processor_response_code__LM' => "Merchant Montly Limit Exceeded",
    'processor_response_code__LT' => "Merchant Per Transaction Limit Exceeded",
    'processor_response_code__NR' => "Nacha Reject",
    'processor_response_code__OL' => "Merchant Over Processing Limit",
    'processor_response_code__PP' => "Purged Payment",
    'processor_response_code__RC' => "Stop Recurring",
    'processor_response_code__SR' => "Transaction Rejected at Settlement",
    'processor_response_code__UC' => "Refund Cannot Exceed Charge Amount",
    'processor_response_code__NL' => "Aborted because of a system error",
    'processor_response_code__AB' => "Aborted because of an upstream system error",
    'processor_response_code__N7' => "CVV2/CVC2 mismatch",
    'processor_response_code__N4' => "Amount exceeds issuer withdrawal limit",
    'processor_response_code__RE' => "AVS: System is not working",
    'processor_response_code__SE' => "AVS: System is unavailable",
    'processor_response_code__EE' => "AVS: Invalid ZIP",
    'processor_response_code__GE' => "AVS: International support is not available",
    'processor_response_code__XE' => "AVS: No Match: Address and ZIP",
    'processor_response_code__YE' => "AVS: No Match: Address and ZIP",
    'processor_response_code__OE' => "AVS: No Match: Address or ZIP",
    'processor_response_code__UE' => "AVS: Cardholder address is unavailable",
    'processor_response_code__ZE' => "AVS: Mo Match: ZIP",

    'processor_response_avs' => "Address Verification",
    'processor_response_avs__A' => "Match: Address only (no ZIP code)",
    'processor_response_avs__B' => "Match: Address only (no ZIP code)",
    'processor_response_avs__C' => "No Match",
    'processor_response_avs__D' => "Match: Address and 9-digit ZIP code",
    'processor_response_avs__E' => "N/A",
    'processor_response_avs__F' => "Match: Address and 9-digit ZIP code",
    'processor_response_avs__G' => "N/A",
    'processor_response_avs__I' => "N/A",
    'processor_response_avs__K' => "Match: Card holder name only",
    'processor_response_avs__L' => "Match: Card holder name and address",
    'processor_response_avs__M' => "Match: Address and ZIP code",
    'processor_response_avs__N' => "No Match",
    'processor_response_avs__O' => "Match: Card holder name and address",
    'processor_response_avs__P' => "Match: ZIP code only",
    'processor_response_avs__R' => "N/A",
    'processor_response_avs__S' => "Service not supported",
    'processor_response_avs__U' => "Service unavailable",
    'processor_response_avs__W' => "Match: 9-digit ZIP code only",
    'processor_response_avs__X' => "Match: Address and 9-digit ZIP code",
    'processor_response_avs__Y' => "Match: Address and 5-digit ZIP code",
    'processor_response_avs__Z' => "Match: 5-digit ZIP code only",

    'processor_response_cvv' => "CVV Match",
    'processor_response_cvv__E' => "Unknown error (N/A)",
    'processor_response_cvv__I' => "N/A",
    'processor_response_cvv__M' => "Match",
    'processor_response_cvv__N' => "No Match",
    'processor_response_cvv__P' => "Not processed (N/A)",
    'processor_response_cvv__S' => "Service not supported (N/A)",
    'processor_response_cvv__U' => "Unknown Issuer (N/A)",
    'processor_response_cvv__X' => "No response (N/A)",
    'processor_response_cvv__' => "No response (N/A)",

	/* !Cookies */
	'cookie_cm_reg_description' => "This cookie stores an invoice ID if a purchase is being made during registration",
	'cookie_location_description' => "This cookie stores an estimated location of the member, it is used to calculate taxes according to the members region.",
	'cookie_currency_description' => "This cookie stores the currency that the member has selected to view the site in.",
	'cookie_guestTransactionKey_description' => "This cookie stores a transaction key for a guest member, it is used to identify the guest when viewing a pending transaction.",

	'nexus_prune_history' => "Prune Commerce History",
	'nexus_prune_history_desc' => "Enabling this setting will prune additional financial history such as when purchases were cancelled and invoices were sent. Invoices and purchase data is never removed.",
