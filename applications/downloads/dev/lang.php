...
$lang = array(
	...
	'__defart_downloads_file_comment_plural'=> "{!#[1:comment][?:comments]} on a file",
	'__defart_downloads_file'				=> "file",
	'__defart_downloads_file_plural'		=> "{!#[1:file][?:files]}",
	'__defart_downloads_file_review'		=> "review on a file",
	'__defart_downloads_file_review_plural'	=> "{!#[1:review][?:reviews]} on a file",
	'__defart_downloads_file_pending'		=> "new versions",
	...
	'download_categories_lc'			=> "downloads categories",
	...
	'downloads_file_sg_lc'					=> "downloads file",
	...
	'modlog__action_restorebackup_stats'		=> "Restored a previous version of a file",
	'modlog__action_visibilitybackup_stats'		=> "Toggled visibility of a previous version of a file",
	'modlog__action_deletebackup_stats'			=> "Deleted a previous version of a file",
	'modlog__action_purchasestatus_stats' 		=> "Toggled purchase status of a file",
	'modlog__action_newversion_reject_stats'	=> "Rejected a new version of a file",
	'modlog__action_newversion_approved_stats'	=> "Approved a new version of a file",
	...
	'crequire_changelog'                   => "Require Changelog?",
	...
	'cforum_on_desc'						=> "Post a topic to the specific forum each time a new file is submitted.",
	'cforum_id'								=> "Forum",
	...
	'idm_default_view'						=> "Default category view",
	'idm_default_view_choose'				=> "Member can choose?",
	'downloads_default_view_table' 			=> 'Table: A traditional table view',
	'downloads_default_view_grid' 			=> 'Grid: Display files as cards in a grid',
	'downloads_default_view_choose' 		=> 'Members can choose?',
	'downloads_default_view_choose_desc' => 'Select the views you will allow members to choose from',
	'downloads_default_view_choose_none' => 'Do not allow members to choose',
	...
	'menu__downloads_stats_topdownloads'	=> "Top Files",
	...
	'r__topdownloads_manage'				=> "Can view Top Files?",
	...
	'downloads_stats_uploader_count'			=> "{# [1:member][?:members]} uploaded files.",
	'downloads_stats_downloader_count'			=> "{# [1:member][?:members]} downloaded files.",
	
	/* !ACP Log */
	'ipAddresses__downloads_DownloadLog'	=> "Downloads",
	
	/* !ACP Logs */
	'acplogs__downloads_resync_topics'	=> "Resynchronized topic content for %s",
	...
	'notification__new_file_version_title'	=> "A file was updated",
	...
	'file_version_pending_cannot_approve' => "The base version of this file is pending approval, this base version must be approved before this version can be approved.",
	...
	/* Achievements */
	'achievement_filter_DownloadFile_nth_suffix' => "th download",
	'achievement_filter_DownloadFile_receiver' => "To the user who uploaded the file",
	'achievement_filter_DownloadFile_giver' => "To the user who downloaded the file",
	'AchievementAction__DownloadFile_log'	=> "Downloaded the file %s",
	'AchievementAction__DownloadFile_title_generic' => "file downloaded",
	'AchievementAction__DownloadFile_title' => "User downloads a file",
	'AchievementAction__DownloadFile' => "Member downloads a Downloads File",

	/* API */
	'webhook_downloads_new_version'	=> "Fired when a new version gets available",
);
