...
$lang = array(
	'__app_calendar'						=> "Events",
	'frontnavigation_calendar'				=> "Events",
	'__indefart_calendar_event_comment'		=> "a comment on an event",
	'__indefart_calendar_event'				=> "an event",
	'__indefart_calendar_event_review'		=> "a review on an event",
	'__defart_calendar_event_comment'		=> "comment on an event",
	'__defart_calendar_event_comment_plural'=> "{!#[1:comment][?:comments]} on an event",
	'__defart_calendar_event'				=> "event",
	'__defart_calendar_event_plural'		=> "{!#[1:event][?:events]}",
	'__defart_calendar_event_review'		=> "review on an event",
	'__defart_calendar_event_review_plural'	=> "{!#[1:review][?:reviews]} on an event",
	'calendar_event_container'				=> "calendar",

	'menu__calendar_calendars'				=> "Events",
	...
	'r__rsvp'                               => "Statistics",
	'r__rsvp_manage'                        => "Can view RSVP statistics?",
	...
	'showing_events_near_you' => "Showing events near your current location.",
	'see_more_events_near_you' => "See more events by location",
	'event_album'							=> "Album",
	...
	'notification__event_reminder_title'=> "Upcoming {!#[1:event][?:events]}",
	...
	'cal_allow_anonymous'					=> "Allow anonymous posts?",

	/* !Achievements */
	'AchievementAction__Rsvp' 				=> "Member RSVP's for an event",
	'achievement_filter_Rsvp_nth_suffix'	=> "<span data-role='th'>th</span> such RSVP",
	'achievement_filter_Rsvp_receiver'		=> "To the user who posted the event",
	'achievement_filter_Rsvp_giver'			=> "To the user who RSVP'd",
	'AchievementAction__Rsvp_log'			=> "RSVP'd to %s",
	'AchievementAction__Rsvp_title'			=> 'Event RSVP',
	
	/* !Stats */
	'menu__calendar_stats'					=> "Calendar",
	'emailstats__notification_event_reminder'	=> "Event Reminders",
	
	'menu__calendar_stats_rsvp'				=> "RSVP",
	'calendar_stats_rsvp_title'				=> "RSVPs over time",
	'calendar_stats_rsvp_response_0'		=> "Not Going",
	'calendar_stats_rsvp_response_1'		=> "Going",
	'calendar_stats_rsvp_response_2'		=> "Maybe",
	
	
	'menu__calendar_stats_venues'			=> "Venues",

	/* Webhooks */
	'webhook_calendarEvent_rsvp' => "Fired when somebody changes his RSVP status",
	...
	'event_view_overview' 					=> "Overview",
	'event_view_daily' 						=> "Daily",
	'event_view_weekly' 					=> "Weekly",
	'event_view_monthly' 					=> "Monthly",

	'events_search_your_location'			=> "Your location",
	'events_search_use_location'			=> "Use my location",
	'events_search_cancel_location'			=> "Cancel Location",
	'events_search_location'				=> "Location",
	'events_search_search_location'			=> "Search location",
	'events_search_type'					=> "Type",
	'events_search_from'					=> "From",
	'events_search_to'						=> "To",
	'events_search_search'					=> "Search",
	'events_search_events'					=> "Search Events",
	'events_search_back_to_overview'		=> "Back to overview",
	'events_search_sort_by'					=> "Sort By:",
	'events_search_distance'				=> "Distance",
	'events_search_date'					=> "Date",
	'events_search_show_more'				=> "Show more results",
	'events_search_no_events'				=> "No more events to show",
	'events_search_no_events_long'			=> "There were no events matching your search",
	'events_happening_near_you'				=> "Happening Near You",
	'events_online_events'					=> "Online Events",
	'events_browse_by_month'				=> "Browse By Month",
	'events_no_more_this_month'				=> "No more events this month",
	'events_show_more'						=> "Show more events",
	'map_center_lat'						=> "Map center latitude",
	'map_center_lon'						=> "Map center longitude",
	'map_center_lat_desc'					=> "The default latitude to use when no user location can be determined by geolocation or ip lookup.",
	'map_center_lon_desc'					=> "The default longitude to use when no user location can be determined by geolocation or ip lookup.",
	'event_happening_now'					=> "Happening Now",
	'event_happening_today'					=> "Happening Today",
	'events_near_you_soon'					=> "We couldn't find any events happening soon near you. Check back later!",
);
