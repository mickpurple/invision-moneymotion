...
;( function($, _, undefined){
	...
	ips.controller.register('core.front.core.app', {
		 ...
		 */
		setup: function () {
			// Check to see if we need to bust a cache
			if ( parseInt( ipsSettings['memberID'] ) == 0 && ips.utils.cookie.get('loggedIn') !== undefined && parseInt( ips.utils.cookie.get('loggedIn') ) > 0 ) {
